"""
Django settings for project_gyminy project.
...
SECRET_KEY = '$z!bsg10e!1^h*=qk5(vepxh3b1j&a4-vcz-aq(n1hw4!2@vsz'
...
ROOT_URLCONF = 'project_gyminy.urls'
...
WSGI_APPLICATION = 'project_gyminy.wsgi.application'
